...
if(MSVC)
  ...
  CHECK_CXX_COMPILER_FLAG("-Wunnecessary-virtual-specifier" HAVE_UNNECESSARY_VIRTUAL_SPECIFIER)
  if(HAVE_UNNECESSARY_VIRTUAL_SPECIFIER)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-unnecessary-virtual-specifier")
  endif()
  if(MINGW)
...
if(FAIL_ON_WARNINGS)
  if(MSVC)
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Werror -Wno-error=unused-but-set-variable")
  endif()
endif()
